...
public: 
  ...
  void drive_distance(float distance, float heading, float drive_max_voltage);
  ...
  void drive_side_distance(float distance, float drive_max_voltage, float left_kp, float left_ki, float left_kd, float left_starti, float right_kp, float right_ki, float right_kd, float right_starti);
  void drive_side_distance(float distance, float heading, float drive_max_voltage, float heading_max_voltage, float drive_settle_error, float drive_settle_time, float drive_timeout, float left_kp, float left_ki, float left_kd, float left_starti, float right_kp, float right_ki, float right_kd, float right_starti, float heading_kp, float heading_ki, float heading_kd, float heading_starti);

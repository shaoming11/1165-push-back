...
void pre_auton() {
  ...
  double leftArc = S_LEFT * chassis.get_absolute_heading() * (LeftTrack.position(degrees) * 2.75 * 2*M_PI / 360); // distance travelled in inches l = r theta
  double rearArc = S_REAR * chassis.get_absolute_heading() * (RearTrack.position(degrees) * 2.75 * 2*M_PI / 360);
  ...
  while(!auto_started){
    ...
    leftArc = S_LEFT * chassis.get_absolute_heading() * (LeftTrack.position(degrees) * 2.75 * 2*M_PI / 360);
    rearArc = S_REAR * chassis.get_absolute_heading() * (RearTrack.position(degrees) * 2.75 * 2*M_PI / 360);

    Brain.Screen.printAt(5, 160, "Actual Left Arc:");
    Brain.Screen.printAt(5, 180, "%f", (LeftTrack.position(degrees) * 2.75 * 2*M_PI / 360));
    Brain.Screen.printAt(5, 200, "Actual Rear Arc:");
    Brain.Screen.printAt(5, 220, "%f", (RearTrack.position(degrees) * 2.75 * 2*M_PI / 360));
    
    Brain.Screen.printAt(5, 240, "Selected Auton:");
    switch(current_auton_selection){
      case 0:
        Brain.Screen.printAt(5, 260, "Auton 1");
        break;
      case 1:
        Brain.Screen.printAt(5, 260, "Auton 2");
        break;
      case 2:
        Brain.Screen.printAt(5, 260, "Auton 3");
        break;
      case 3:
        Brain.Screen.printAt(5, 260, "Auton 4");
        break;
      case 4:
        Brain.Screen.printAt(5, 260, "Auton 5");
        break;
      case 5:
        Brain.Screen.printAt(5, 260, "Auton 6");
        break;
      case 6:
        Brain.Screen.printAt(5, 260, "Auton 7");
        break;
      case 7:
        Brain.Screen.printAt(5, 260, "Auton 8");
        break;
    }
